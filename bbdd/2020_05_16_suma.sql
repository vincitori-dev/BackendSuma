...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-05-2020 a las 00:05:35
...
(45, 'Gastos Habituales', '', 143.52, 60, 3, 0, 1589578958, 1589579610),
(46, 'Educación', '', 100, 10, 2, 0, 1589579057, 1589579292),
(47, 'Ocio', '', 91.5, 10, 6, 0, 1589579110, 1589579445),
(48, 'Generación de Activos', '', 15, 10, 7, 0, 1589579187, 1589579567),
(49, 'Liquidez', '', 100, 10, 5, 0, 1589579226, 1589579292);
...
--
ALTER TABLE `cuenta`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'El identificador de la cuenta', AUTO_INCREMENT=50;
